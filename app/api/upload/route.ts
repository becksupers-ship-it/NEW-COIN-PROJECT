...
export async function POST(request: NextRequest) {
  try {
    ...
    const folder = uploadType === 'program-image' ? 'bonded-friends/programs' : uploadType === 'member-image' || uploadType === 'executive-image' ? 'bonded-friends/executives' : isDonationReceipt ? 'bonded-friends/donation-receipts' : 'bonded-friends'
